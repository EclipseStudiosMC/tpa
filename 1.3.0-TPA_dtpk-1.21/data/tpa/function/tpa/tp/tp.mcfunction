...
execute if score .debug_mode tpa.config matches 1 run tellraw @a ["",{"text":"[TPA] ","color":"yellow"},{"text":"Debug: ","color":"blue"},{"text":"Requester score: ","color":"gold"},{"score":{"name":"@p[tag=tpa.this_is_requester]","objective":"tpa.want_tp_to"},"color":"dark_aqua"},{"text":" Destination score: ","color":"gold"},{"score":{"name":"@s","objective":"tpa.want_tp_to"},"color":"dark_aqua"}]
