...
# Message:
tellraw @s ["",{"text":"[TPA] ","color":"yellow"},{"text":"[-10s] ","color":"gold","click_event":{"action":"run_command","command":"/function tpa:tpa/gamerule/timer {add:-200}"}},{"text":"[-1s] ","color":"gold","click_event":{"action":"run_command","command":"/function tpa:tpa/gamerule/timer {add:-20}"}},{"score":{"name":".timer_s","objective":"tpa.timer"},"color":"yellow"},{"text":"s","color":"yellow"},{"text":" [1s] ","color":"gold","click_event":{"action":"run_command","command":"/function tpa:tpa/gamerule/timer {add:20}"}},{"text":"[10s]","color":"gold","click_event":{"action":"run_command","command":"/function tpa:tpa/gamerule/timer {add:200}"}}]
